...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-7IK1942\\SQLEXPRESS;Database=registroAlumno;Persist Security Info=True;User ID=CheleCuajada;Password= elsalvadorunido;Encrypt=False;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83F6C8C8C0C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83FD9012F63");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83FD4F40669");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F1FC25DB2");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC7F9964D80");
